    ...
    public function index()
    {
        $settings = [
            ...
            'module_availability' => [
                ...
                'broker_module_enabled' => \App\Models\BrokerSetting::isEnabled('broker_module_enabled', true),
            ...
            'broker' => [
                'module_enabled' => \App\Models\BrokerSetting::isEnabled('broker_module_enabled', true),
                'verification_enabled' => \App\Models\BrokerSetting::isEnabled('broker_verification_enabled', true),
                'listing_charges_enabled' => \App\Models\BrokerSetting::isEnabled('broker_listing_charges_enabled', false),
                'featured_enabled' => \App\Models\BrokerSetting::isEnabled('broker_featured_enabled', true),
                'per_listing_charge' => (float) \App\Models\BrokerSetting::get('broker_per_listing_charge', 99),
                'featured_charge' => (float) \App\Models\BrokerSetting::get('broker_featured_charge', 99),
                'free_listing_limit' => (int) \App\Models\BrokerSetting::get('broker_free_listing_limit', 0),
            ],
            'promo_modal' => [
                'enabled' => filter_var(Setting::get('promo_modal_enabled', '1'), FILTER_VALIDATE_BOOLEAN),
                'audience' => Setting::get('promo_modal_audience', 'all'),
                'type' => Setting::get('promo_modal_type', 'both'),
                'badge' => Setting::get('promo_modal_badge', 'Special Offer'),
                'title' => Setting::get('promo_modal_title', ''),
                'description' => Setting::get('promo_modal_description', ''),
                'btn_text' => Setting::get('promo_modal_btn_text', 'Explore Deals'),
                'btn_url' => Setting::get('promo_modal_btn_url', ''),
                'delay_seconds' => (int) Setting::get('promo_modal_delay', 5),
                'image_url' => Setting::get('promo_modal_image') ? asset('storage/' . Setting::get('promo_modal_image')) : null,
            ],
            'maintenance' => [
