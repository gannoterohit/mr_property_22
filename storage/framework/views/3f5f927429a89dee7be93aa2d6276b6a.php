...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/css/mobile-app.css', 'resources/js/app.js']); ?>
    <title><?php echo $__env->yieldContent('title', \App\Models\Setting::get('website_name', 'RoomRental') . ' - Find Your Perfect Room'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', \App\Models\Setting::get('seo_meta_description', 'Find your perfect room in your city. Browse verified room listings.')); ?>">
    <meta name="keywords" content="<?php echo $__env->yieldContent('keywords', \App\Models\Setting::get('seo_meta_keywords', 'room rental, apartment, house, property')); ?>">
    <meta name="author" content="<?php echo e(\App\Models\Setting::get('website_name', 'RoomRental')); ?>">
    <meta name="robots" content="<?php echo e(request()->routeIs('admin.*', 'owner.*', 'dashboard', 'profile.*', 'wallet', 'referral.*', 'wishlist.*', 'complaints.*') ? 'noindex, nofollow' : 'index, follow'); ?>">
    <meta name="theme-color" content="<?php echo e(\App\Models\Setting::get('primary_color', '#4F46E5')); ?>">
    ...
    <?php echo $__env->yieldContent('layout-seo'); ?>
    <?php echo $__env->yieldContent('layout-structured-data'); ?>
    <?php echo $__env->yieldContent('layout-tracking'); ?>
    ...
    <style>
        :root {
            --primary: <?php echo e(\App\Models\Setting::get('primary_color', '#4F46E5')); ?>;
            --primary-dark: <?php echo e(\App\Models\Setting::get('primary_color', '#4F46E5')); ?>;
            --accent: #F59E0B;
            --secondary: <?php echo e(\App\Models\Setting::get('secondary_color', '#10B981')); ?>;
            --danger: #EF4444;
            --primary-rgb: <?php echo e(implode(',', sscanf(ltrim(\App\Models\Setting::get('primary_color', '#4F46E5'), '#'), '%02x%02x%02x'))); ?>;
            --secondary-rgb: <?php echo e(implode(',', sscanf(ltrim(\App\Models\Setting::get('secondary_color', '#10B981'), '#'), '%02x%02x%02x'))); ?>;
            --gray-light: #F8FAFC;
            --bg-premium: #F8FAFC;
            --text-main: #1E293B;
            --text-dark: #0F172A;
    ...
    <style>
        :root { --primary: <?php echo e(\App\Models\Setting::get('primary_color', '#4F46E5')); ?>; --secondary: <?php echo e(\App\Models\Setting::get('secondary_color', '#10B981')); ?>; }
...
<body class="bg-gray-50 flex flex-col min-h-screen mobile-app-view <?php echo e(request()->routeIs('admin.*') ? 'admin-page' : ''); ?>">
    ...
    <?php echo $__env->yieldContent('layout-top-banner'); ?>
    <?php echo $__env->yieldContent('layout-navigation'); ?>
    <?php echo $__env->yieldContent('layout-loading'); ?>

    <!-- Main Content -->
    <main class="pt-16 md:pt-0 <?php echo e(Route::is('pages.*', 'cms-pages.show') ? 'cms-content-main' : ''); ?>">
        <?php echo $__env->yieldContent('content'); ?>
    </main>

    <?php echo $__env->yieldContent('layout-footer'); ?>
    <?php echo $__env->yieldContent('layout-bottom-navigation'); ?>


    <!-- Google Ads Conversion Tracking (Fire after successful payment) -->
    <?php if(session('google_ads_conversion') && app()->environment('production') && \App\Models\Setting::get('google_ads_enabled') == '1'): ?>
        <?php
        ...
        ?>
        <?php if($adsId && $convLabel && isset($conv['amount'])): ?>
        <script>
            if (typeof trackAdsConversion === 'function') {
                trackAdsConversion('<?php echo e($convLabel); ?>', <?php echo e($conv['amount']); ?>, 'INR');
            } else if (typeof gtag !== 'undefined') {
                gtag('event', 'conversion', {
                    'send_to': '<?php echo e($adsId); ?>/<?php echo e($convLabel); ?>',
                    'value': <?php echo e($conv['amount']); ?>,
                    'currency': 'INR'
                });
            }
        </script>
        <?php endif; ?>
        <?php echo e(session()->forget('google_ads_conversion')); ?>

    <?php endif; ?>

    <!-- Scripts Loaded in Footer for Performance -->
    <?php echo $__env->yieldPushContent('sweetalert'); ?> 
    <script defer>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <?php if(isset($errors) && $errors->any()): ?>
                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $validationError): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    toastr.error(<?php echo json_encode($validationError, 15, 512) ?>, 'Please check the form');
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                const validationErrors = <?php echo json_encode($errors->toArray(), 15, 512) ?>;
                const oldInput = <?php echo json_encode(session()->getOldInput(), 15, 512) ?>;
    ...
    <?php echo $__env->yieldContent('layout-popup'); ?>
    
    <?php if(session('signup_success') && app()->environment('production') && \App\Models\Setting::get('google_ads_enabled') == '1'): ?>
        <?php
        ...
        <?php if($signupLabel): ?>
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    if (typeof trackAdsConversion === 'function') {
                        trackAdsConversion('<?php echo e($signupLabel); ?>', 0, 'INR');
                    }
                });
            </script>
        <?php endif; ?>
        <?php echo e(session()->forget('signup_success')); ?>
...
(function () {
    ...
    const urls = {
        fetch:   "<?php echo e(route('user.notifications.unreadCount')); ?>",
        list:    "<?php echo e(route('user.notifications.index')); ?>",
        readAll: "<?php echo e(route('user.notifications.readAll')); ?>",
        read:    (id) => "<?php echo e(url('/notifications')); ?>/" + id + "/read",
...
<?php if(\App\Models\Setting::get('firebase_push_enabled', '1') === '1' && \App\Models\Setting::get('firebase_web_api_key') && \App\Models\Setting::get('firebase_project_id')): ?>
...
(function() {
    ...
    const firebaseConfig = {
        apiKey:            "<?php echo e(\App\Models\Setting::get('firebase_web_api_key')); ?>",
        authDomain:        "<?php echo e(\App\Models\Setting::get('firebase_project_id')); ?>.firebaseapp.com",
        projectId:         "<?php echo e(\App\Models\Setting::get('firebase_project_id')); ?>",
        storageBucket:     "<?php echo e(\App\Models\Setting::get('firebase_project_id')); ?>.appspot.com",
        messagingSenderId: "<?php echo e(\App\Models\Setting::get('firebase_messaging_sender_id')); ?>",
        appId:             "<?php echo e(\App\Models\Setting::get('firebase_app_id')); ?>"
    };

    try {
        if (!firebase.apps.length) firebase.initializeApp(firebaseConfig);
        const messaging = firebase.messaging();
        const vapidKey  = "<?php echo e(\App\Models\Setting::get('firebase_vapid_key')); ?>";
                ...
                if (permission === 'granted') {
                    messaging.getToken({ serviceWorkerRegistration: registration, vapidKey: vapidKey || undefined })
                        .then(function(currentToken) {
                            if (currentToken) {
                                fetch("<?php echo e(route('web.push.store')); ?>", {
                                    method: 'POST',
                                    headers: {
    ...
    <script defer src="<?php echo e(asset('assets/js/toastr.min.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\apnanest\resources\views/layouts/base.blade.php ENDPATH**/ ?>