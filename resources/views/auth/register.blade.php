            ...
            <div id="details-step">
                <form id="details-form" novalidate>@csrf
                    ...
                    <label class="terms-row">
                        ...
                        <span>
                            I agree to the
                            @if($termsLive)<a href="{{ url('/page/terms-and-conditions') }}" target="_blank">Terms and Conditions</a>@else<span>Terms and Conditions</span>@endif
                            and acknowledge the
                            @if($privacyLive)<a href="{{ url('/page/privacy-policy') }}" target="_blank">Privacy Policy</a>@else<span>Privacy Policy</span>@endif.
                        </span>
                    </label>
