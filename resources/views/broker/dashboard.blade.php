        ...
        <a href="{{ route('agent.rooms.create') }}" class="inline-flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-5 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-indigo-700 transition">
            ...
            <section class="owner-dashboard-body mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="owner-dashboard-panel rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                    ...
                    @empty
                        <div class="px-5 py-12 text-center text-sm text-slate-500">No properties listed yet. <a href="{{ route('agent.rooms.create') }}" class="text-indigo-600 font-bold">Create your first listing</a></div>
                    @endforelse
                </div>
