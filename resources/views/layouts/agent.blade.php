...
<div class="owner-workspace">
    ...
    <main class="owner-main">
        ...
        <header class="owner-topbar">
            <div class="min-w-0">
                <p class="text-[10px] uppercase tracking-[.16em] font-bold text-slate-400">Agent Workspace</p>
                <h1 class="text-sm font-bold text-slate-800 truncate">@yield('title', 'Agent Dashboard')</h1>
            </div>
            <div class="flex items-center gap-2.5">
                {{-- View Site --}}
                <a href="{{ route('home') }}" target="_blank"
                   class="owner-theme-link hidden sm:flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-600 rounded-lg border border-slate-200 bg-white hover:border-slate-300 transition shadow-sm">
                ...
                <div class="h-10 pl-1.5 pr-3 rounded-xl border border-slate-200 bg-white flex items-center gap-2.5 shadow-sm">
                    ...
                    @else
                        <div class="owner-theme-avatar w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold shadow-sm">
