...
<div class="owner-workspace">
    @include('customer.partials.sidebar', ['active' => ''])

    <main class="owner-main">
        <header class="owner-topbar">
            <div class="min-w-0">
                <p class="text-[11px] uppercase tracking-[.16em] font-bold text-slate-400">Customer Dashboard</p>
                <h1 class="text-base font-bold text-slate-800 truncate">@yield('title', 'My Account')</h1>
            </div>
            <div class="flex items-center gap-3">
                ...
                <div class="h-10 pl-1.5 pr-3 rounded-xl border border-slate-200 bg-white flex items-center gap-2.5 shadow-sm">
                    ...
                    <div class="hidden sm:block leading-tight max-w-[140px]">
                        ...
                        <p class="text-[9px] font-semibold uppercase tracking-wider text-slate-400">Customer</p>
                    </div>
                </div>
            </div>
        </header>
