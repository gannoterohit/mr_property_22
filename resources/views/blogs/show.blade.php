...
.article-label{display:inline-flex;align-items:center;gap:7px;margin-bottom:17px;padding:7px 11px;border-radius:999px;background:rgba(var(--primary-rgb),.08);color:var(--primary);font-size:10px;font-weight:900;text-transform:uppercase;letter-spacing:.1em}
...
.article-author-icon{display:grid;place-items:center;width:42px;height:42px;border:1px solid rgba(var(--primary-rgb),.2);border-radius:12px;background:rgba(var(--primary-rgb),.08);color:var(--primary)}
...
.article-share a:hover{border-color:rgba(var(--primary-rgb),.3);color:var(--primary);background:rgba(var(--primary-rgb),.08)}
...
.article-body blockquote{margin:2em 0;padding:18px 20px;border-left:4px solid var(--primary);border-radius:0 10px 10px 0;background:rgba(var(--primary-rgb),.08);color:var(--primary);font-weight:650}
...
.article-thanks{display:flex;align-items:center;justify-content:space-between;gap:20px;margin-top:36px;padding:22px;border:1px solid rgba(var(--primary-rgb),.2);border-radius:12px;background:rgba(var(--primary-rgb),.04)}
.article-thanks strong{display:block;font-size:14px}.article-thanks p{margin:4px 0 0;color:#64748b;font-size:12px}
.article-thanks a{flex:none;padding:11px 15px;border-radius:9px;background:var(--primary);color:#fff;font-size:12px;font-weight:850;text-decoration:none}
...
.article-widget-title{display:flex;align-items:center;gap:9px;margin:0 0 18px;font-size:14px;font-weight:900}.article-widget-title:before{content:"";width:4px;height:20px;border-radius:9px;background:var(--primary)}
...
.recent-post:hover h3{color:var(--primary)}.recent-post small{color:#94a3b8;font-size:9px;font-weight:700;text-transform:uppercase}
.article-cta{padding:26px;border-radius:15px;background:linear-gradient(145deg,rgba(var(--primary-rgb),.95),#0f172a);color:#fff}.article-cta i{font-size:24px;color:rgba(var(--secondary-rgb),.85)}.article-cta h2{margin:16px 0 9px;font-size:21px;line-height:1.3;font-weight:900}.article-cta p{margin:0;color:#cbd5e1;font-size:12px;line-height:1.65}
.article-cta a{display:block;margin-top:20px;padding:12px;border-radius:9px;background:#fff;color:var(--primary);text-align:center;font-size:12px;font-weight:900;text-decoration:none}
