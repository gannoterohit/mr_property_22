    ...
    <section class="hiw-cms-section">
        <div class="hiw-cms-wrap">
            <div class="hiw-cms-alert">
                ...
                <a href="{{ url('/safety-tips') }}">{{ \App\Models\Setting::get('hiw_safety_button_label', 'Safety Tips') }}</a>
            </div>
        </div>
    </section>
</main>
...
<script>
(function () {
    var slides = document.querySelectorAll('.hiw-cms-hero-slide');
