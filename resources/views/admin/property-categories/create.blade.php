...
<div class="max-w-2xl mx-auto bg-white rounded-2xl border border-slate-200 p-5">
    <h2 class="text-xl font-bold text-slate-900">Create Property Category</h2>
    <form action="{{ route('admin.property-categories.store') }}" method="POST" class="mt-4 space-y-4">
        @csrf
        <div>
