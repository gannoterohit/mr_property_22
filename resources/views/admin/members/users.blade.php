        ...
        <div class="overflow-x-auto">
            <table class="people-table admin-table-base">
                ...
                <tbody class="divide-y">
                    @forelse($users as $user)
                        <tr class="hover:bg-slate-50/70">
                            ...
                            <td class="px-4 py-4">
                                ...
                                @endif
                                <p class="mt-1 text-[10px] text-slate-400">Joined {{ $user->created_at->format('d M Y') }}</p>
                            </td>
                            <td class="px-4 py-4">
                    ...
                    @empty
                        <tr><td colspan="5" class="p-14 text-center"><i class="fas fa-users-slash text-3xl text-slate-300"></i><p class="mt-3 text-sm font-bold text-slate-600">No users found</p><p class="text-xs text-slate-400">Try changing the filters.</p></td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
